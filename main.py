...
async def help(message: types.Message):
    await message.answer(f"""Обычно мне говорят, 'если тебе нужна помощь - помоги себе сам', 
    но я не очень умный и люблю когда все просто и понятно. Вот такие команды я умею обрабатывать:\n\n
